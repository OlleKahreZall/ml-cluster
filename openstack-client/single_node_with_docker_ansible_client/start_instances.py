...
instance_prod = nova.servers.create(name="Group3Prod_server_"+str(identifier), image=image, flavor=flavor, key_name='de2-ssh-key',userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="Group3Dev_server_"+str(identifier), image=image, flavor=flavor, key_name='de2-ssh-key',userdata=userdata_dev, nics=nics,security_groups=secgroups)
