...
#we use the multi layer perceptron (MLP) algorithm
...
#X_train, X_test, y_train, y_test = train_test_split(features_selected, target.values.ravel(), test_size=0.3, random_state=1)


#best parameters for the hidden_layer_sizes
#25 
#20, 16 
#41 
#20, 11, 4 
...
nn = MLPRegressor(random_state=1, max_iter=10000, hidden_layer_sizes=(20, 16))
nn.fit(features_selected, target.values.ravel())
